...
export default function TherapistDashboard() {
  ...
  return (
    <FlatList
      ...
      contentContainerStyle={{ padding: 22, paddingTop: 50, paddingBottom: 34, flexGrow: 1 }}
      ...
      ListEmptyComponent={
        <Card>
          <Text style={{ color: COLORS.inkMid }}>No sessions scheduled today.</Text>
        </Card>
      }
      renderItem={({ item }) => (
        <Pressable
