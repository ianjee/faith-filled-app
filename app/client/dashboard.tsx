  ...
  const menu = [
    {
      ...
      label: "Intake form",
      icon: "✦",
      desc: "Keep your wellness information updated.",
    },
    {
      href: "/client/health-history",
      label: "Health history",
      icon: "♡",
      desc: "Review your health information.",
    },
    {
      href: "/client/consent",
      label: "Consent & policies",
      icon: "✓",
      desc: "Review your signed documents.",
    },
    {
      href: "/client/appointments",
      label: "Appointments",
      icon: "◷",
      desc: "View your upcoming and past sessions.",
    },
    {
      href: "/client/home-care",
      label: "Home care",
      icon: "⌁",
      desc: "View recommendations from your therapist.",
    },
    {
      href: "/client/survey",
      label: "Session survey",
      icon: "♡",
      desc: "Share how you felt after a session.",
    },
  ];
